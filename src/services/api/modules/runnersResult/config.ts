/**
 * Configuration for Runners Result data source
 * 
...
export const RUNNERS_RESULT_CONFIG = {
  // Set to true when GraphQL schema includes Runner Result types
  USE_GRAPHQL: true,
...
export type RunnersQCConfig = typeof RUNNERS_RESULT_CONFIG;