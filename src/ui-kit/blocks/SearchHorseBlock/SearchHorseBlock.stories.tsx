...
export const SearchHorseScreen: React.FC = () => {
  ...
  return (
    <div className="p-4 flex flex-col left-0 right-0">
      <div className="mb-4">
        <SearchInput
          value={searchText}
      ...
      <div>
        ...
        {filteredHorses.map((horse, index) => (
          <HorseListItem
            ...
            subTitle={`(${getFormattedId(horse.hisaHorseId)})`}
            onItemPress={onItemPress}
            isLastItem={index === filteredHorses.length - 1}
          />
        ))}
      </div>
    </div>
...
const meta: Meta<typeof SearchHorseScreen> = {
  title: "Blocks/SearchHorseScreen",
  component: SearchHorseScreen,
};

export default meta;

export const Default: StoryObj<typeof SearchHorseScreen> = {
  render: () => <SearchHorseScreen />,
};
